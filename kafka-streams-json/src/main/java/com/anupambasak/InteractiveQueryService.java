...
public class InteractiveQueryService {
    ...
    private final KafkaStreamsInteractiveQueryService jsonIqService;
    private final RestTemplate restTemplate;
    private final StreamsBuilderFactoryBean streamsBuilderFactoryBean;
    private static final String DATA_STORE = "data-store";

    public InteractiveQueryService(KafkaStreamsInteractiveQueryService jsonIqService, StreamsBuilderFactoryBean streamsBuilderFactoryBean) {
        this.jsonIqService = jsonIqService;
    ...
    public List<DataRecord> getDistributedData(String producerId) {
        ...
        HostInfo hostInfo = jsonIqService.getKafkaStreamsApplicationHostInfo(storeName, producerId,
        ...
        log.info("{}",jsonIqService.getCurrentKafkaStreamsApplicationHostInfo());
        if (jsonIqService.getCurrentKafkaStreamsApplicationHostInfo().equals(hostInfo)) {
...
//            return readKeyValueStoreData(producerId);
    ...
    public List<DataRecord> readSessionStoreData(String producerId) {
        ReadOnlySessionStore<String, List<DataRecord>> store = jsonIqService.retrieveQueryableStore(
    ...
    public List<DataRecord> readKeyValueStoreData(String producerId) {
        ReadOnlyKeyValueStore<String, List<DataRecord>> store = jsonIqService.retrieveQueryableStore(
