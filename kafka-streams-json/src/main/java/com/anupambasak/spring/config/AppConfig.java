...
public class AppConfig {
    ...
    public KafkaStreamsConfiguration jsonKStreamsConfigs(KafkaProperties kafkaProperties,
                                                         Serde<BaseRecord> baseRecordSerde) {

        Map<String, Object> properties = kafkaProperties.buildStreamsProperties();
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "record-processor-json");
        properties.put(StreamsConfig.APPLICATION_SERVER_CONFIG, "localhost:7071");
    ...
    @Bean
    public KafkaStreamsInteractiveQueryService jsonIqService(StreamsBuilderFactoryBean streamsBuilderFactoryBean) {
